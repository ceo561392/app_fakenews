...
model_knn = joblib.load('./lib/weight/title&body_knn_model.pkl')

knn_vectorizer = joblib.load('./lib/weight/title&body_knn_tfidf_vectorizer.pkl')



def predict_tb_knn(text, body):
   
    text_to_predict_tfidf = knn_vectorizer.transform([text + ' ' + body])   
